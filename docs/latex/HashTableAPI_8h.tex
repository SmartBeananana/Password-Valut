...
\begin{DoxyCompactItemize}
\item 
\hyperlink{structHTable}{H\+Table} $\ast$ \hyperlink{HashTableAPI_8h_a18a9041a22e521cf580469930cceaff9}{create\+Table} (size\+\_\+t size, int($\ast$hash\+Function)(size\+\_\+t table\+Size, char $\ast$key), void($\ast$destroy\+Data)(void $\ast$data), void($\ast$print\+Data)(void $\ast$to\+Be\+Printed))
\item 
